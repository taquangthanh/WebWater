		...
		<div
			...
			<div class="col-lg-4">
				<a href="/index" class="text-decoration-none"> <span
					class="h1 text-uppercase text-primary bg-dark px-2">TQT</span> <span
					class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">PH17187</span>
				</a>
			</div>
			...
			<div class="col-lg-3 d-none d-lg-block">
				<a
					...
					<h6 class="text-dark m-0">
						<i class="fa fa-bars mr-2"></i>DrinkWaters
					</h6> <i class=" text-dark"></i>
				</a>
			...
			<div class="col-lg-9">
				<nav
					...
					<a href="" class="text-decoration-none d-block d-lg-none">
						<span class="h1 text-uppercase text-dark bg-light px-2">TQT</span>
						<span class="h1 text-uppercase text-light bg-primary px-2 ml-n1">PH17187</span>
					</a>
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav mr-auto py-0">
							<a href="/index" class="nav-item nav-link active">Home</a> <a
								...
								href="/allwater" class="nav-item nav-link">Product</a>
						...
						<div class="navbar-nav ml-auto py-0 d-none d-lg-block">
							<a href="/cart" class="btn px-0 ml-3"> <i
								class="fas fa-shopping-cart text-primary"></i> <span
								class="badge text-secondary border border-secondary rounded-circle"
								style="padding-bottom: 2px;">${size }</span>
							</a>
						</div>
					</div>
				</nav>
				...
				<div class="col-lg-3 col-md-4 col-sm-6 pb-1">
					<div class="product-item bg-light mb-4">
						<div class="product-img position-relative overflow-hidden">
							<img class="img-fluid w-50 h-50" src="img/${product.photo}"
								alt="">
